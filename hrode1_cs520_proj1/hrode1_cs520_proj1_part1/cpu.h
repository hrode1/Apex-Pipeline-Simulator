...
void 
printRegValues(APEX_CPU* cpu);

int 
integerALU(int input1, int input2);

int 
mulALU(int input1, int input2);

int 
andALU(int input1, int input2);

int 
orALU(int input1, int input2);

int 
xorALU(int input1, int input2);
